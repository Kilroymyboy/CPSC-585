...
#define PROJECTION_LOCATION 8
#define VIEW_LOCATION 9
#define LIGHT_LOCATION 10
#define AMBIENT_LOCATION 11
#define SHADOW_MVP_LOCATION 12
#define SOFT_SHADOW_LOCATION 13
